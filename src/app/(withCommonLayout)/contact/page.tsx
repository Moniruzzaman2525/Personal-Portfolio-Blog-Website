            ...
            <div className=" mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <div className="mt-6 space-y-5 text-lg">
                        ...
                        <p className="text-white font-medium">🌐 <span className="font-semibold">Website:</span> <a href="https://personal-portfolio-blog-website-hazel.vercel.app/" className="hover:underline">https://personal-portfolio-blog-website-hazel.vercel.app</a></p>
                    </div>
